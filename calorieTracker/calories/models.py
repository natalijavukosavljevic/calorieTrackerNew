...
class Food(models.Model):
    #user= models.OneToOneField(User, on_delete=models.CASCADE, null=True, blank=True) #svaki put kada je model izbrisan izbirsan je i profil
...
class Consume(models.Model):
    owner=models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True) #jedan odner vise Consumes 
    food=models.ForeignKey(Food, on_delete=models.CASCADE, null=True, blank=True)  #jedan food vise Consumes
...
class Profile(models.Model):
    ...
    def ConsumeSetbyDate(self,chosenDateYear,chosenDateMonth, chosenDateDay):
        ...
        criterion2=Q(created__year=chosenDateYear, created__month=chosenDateMonth, created__day=chosenDateDay)
